module OpenGraphHelper
  ...
  def description
    "Boston Ruby Group helps you make connections, hack on projects, learn new
    things, and have fun with other Ruby enthusiasts."
  end

  def image_alt_text
    "Photograph of attendees at a Boston Ruby Group event."
  end
end
